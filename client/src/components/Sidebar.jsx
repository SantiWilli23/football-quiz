...
import { Home, Users, History, BarChart3, Swords, Newspaper, User, LogOut, Flame, Gamepad2, Star } from "lucide-react";
...
const externalLinks = [
  { href: "/draft-mundial.html", label: "Draft Mundial", icon: Gamepad2 },
  { href: "/champions-draft.html", label: "Champions Draft", icon: Star },
];
